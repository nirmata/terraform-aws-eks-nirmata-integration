...
# EKS Cluster - only basic configuration, no add-ons or logs
...
# EKS Node Group - basic configuration with single t3a.medium node
resource "aws_eks_node_group" "eks_node_group" {
  ...
  # Only essential updates configuration
  update_config {
    max_unavailable = 1
  }
