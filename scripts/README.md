...
9. (Optional) Patches every ServiceAccount in the `nirmata` namespace to use that secret as an `imagePullSecret`
10. Applies each bucket in order with waits in between, then prints pod status
